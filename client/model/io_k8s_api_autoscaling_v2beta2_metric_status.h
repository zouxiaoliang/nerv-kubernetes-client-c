/*
 * io_k8s_api_autoscaling_v2beta2_metric_status.h
 *
 * MetricStatus describes the last-read state of a single metric.
 */

#ifndef _io_k8s_api_autoscaling_v2beta2_metric_status_H_
#define _io_k8s_api_autoscaling_v2beta2_metric_status_H_
...
typedef struct io_k8s_api_autoscaling_v2beta2_metric_status_t io_k8s_api_autoscaling_v2beta2_metric_status_t;
...
typedef struct io_k8s_api_autoscaling_v2beta2_metric_status_t {
    struct io_k8s_api_autoscaling_v2beta2_container_resource_metric_status_t *container_resource; //model
    struct io_k8s_api_autoscaling_v2beta2_external_metric_status_t *external; //model
    struct io_k8s_api_autoscaling_v2beta2_object_metric_status_t *object; //model
    struct io_k8s_api_autoscaling_v2beta2_pods_metric_status_t *pods; //model
    struct io_k8s_api_autoscaling_v2beta2_resource_metric_status_t *resource; //model
    char *type; // string
...
#endif /* _io_k8s_api_autoscaling_v2beta2_metric_status_H_ */
