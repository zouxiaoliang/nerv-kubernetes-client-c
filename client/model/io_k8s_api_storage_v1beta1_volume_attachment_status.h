/*
 * io_k8s_api_storage_v1beta1_volume_attachment_status.h
 *
 * VolumeAttachmentStatus is the status of a VolumeAttachment request.
 */

#ifndef _io_k8s_api_storage_v1beta1_volume_attachment_status_H_
#define _io_k8s_api_storage_v1beta1_volume_attachment_status_H_
...
typedef struct io_k8s_api_storage_v1beta1_volume_attachment_status_t io_k8s_api_storage_v1beta1_volume_attachment_status_t;

#include "io_k8s_api_storage_v1beta1_volume_error.h"



typedef struct io_k8s_api_storage_v1beta1_volume_attachment_status_t {
    struct io_k8s_api_storage_v1beta1_volume_error_t *attach_error; //model
    int attached; //boolean
    list_t* attachment_metadata; //map
    struct io_k8s_api_storage_v1beta1_volume_error_t *detach_error; //model
...
#endif /* _io_k8s_api_storage_v1beta1_volume_attachment_status_H_ */
