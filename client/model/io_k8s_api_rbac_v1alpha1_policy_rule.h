/*
 * io_k8s_api_rbac_v1alpha1_policy_rule.h
 *
 * PolicyRule holds information that describes a policy rule, but does not contain information about who the rule applies to or which namespace the rule applies to.
 */

#ifndef _io_k8s_api_rbac_v1alpha1_policy_rule_H_
#define _io_k8s_api_rbac_v1alpha1_policy_rule_H_
...
typedef struct io_k8s_api_rbac_v1alpha1_policy_rule_t io_k8s_api_rbac_v1alpha1_policy_rule_t;




typedef struct io_k8s_api_rbac_v1alpha1_policy_rule_t {
...
#endif /* _io_k8s_api_rbac_v1alpha1_policy_rule_H_ */
