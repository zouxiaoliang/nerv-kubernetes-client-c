/*
 * io_k8s_api_core_v1_cinder_persistent_volume_source.h
 *
 * Represents a cinder volume resource in Openstack. A Cinder volume must exist before mounting to a container. The volume must also be in the same region as the kubelet. Cinder volumes support ownership management and SELinux relabeling.
 */

#ifndef _io_k8s_api_core_v1_cinder_persistent_volume_source_H_
#define _io_k8s_api_core_v1_cinder_persistent_volume_source_H_
...
typedef struct io_k8s_api_core_v1_cinder_persistent_volume_source_t io_k8s_api_core_v1_cinder_persistent_volume_source_t;

#include "io_k8s_api_core_v1_secret_reference.h"



typedef struct io_k8s_api_core_v1_cinder_persistent_volume_source_t {
    char *fs_type; // string
...
#endif /* _io_k8s_api_core_v1_cinder_persistent_volume_source_H_ */
