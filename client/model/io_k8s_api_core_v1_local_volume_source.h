/*
 * io_k8s_api_core_v1_local_volume_source.h
 *
 * Local represents directly-attached storage with node affinity (Beta feature)
 */

#ifndef _io_k8s_api_core_v1_local_volume_source_H_
#define _io_k8s_api_core_v1_local_volume_source_H_
...
typedef struct io_k8s_api_core_v1_local_volume_source_t io_k8s_api_core_v1_local_volume_source_t;




typedef struct io_k8s_api_core_v1_local_volume_source_t {
    char *fs_type; // string
    char *path; // string
...
#endif /* _io_k8s_api_core_v1_local_volume_source_H_ */
