/*
 * io_k8s_api_authorization_v1_resource_attributes.h
 *
 * ResourceAttributes includes the authorization attributes available for resource requests to the Authorizer interface
 */

#ifndef _io_k8s_api_authorization_v1_resource_attributes_H_
#define _io_k8s_api_authorization_v1_resource_attributes_H_
...
typedef struct io_k8s_api_authorization_v1_resource_attributes_t io_k8s_api_authorization_v1_resource_attributes_t;




typedef struct io_k8s_api_authorization_v1_resource_attributes_t {
    char *group; // string
    char *name; // string
...
#endif /* _io_k8s_api_authorization_v1_resource_attributes_H_ */
