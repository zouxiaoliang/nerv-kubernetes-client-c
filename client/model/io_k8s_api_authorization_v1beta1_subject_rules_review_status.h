/*
 * io_k8s_api_authorization_v1beta1_subject_rules_review_status.h
 *
 * SubjectRulesReviewStatus contains the result of a rules check. This check can be incomplete depending on the set of authorizers the server is configured with and any errors experienced during evaluation. Because authorization rules are additive, if a rule appears in a list it&#39;s safe to assume the subject has that permission, even if that list is incomplete.
 */

#ifndef _io_k8s_api_authorization_v1beta1_subject_rules_review_status_H_
#define _io_k8s_api_authorization_v1beta1_subject_rules_review_status_H_
...
typedef struct io_k8s_api_authorization_v1beta1_subject_rules_review_status_t io_k8s_api_authorization_v1beta1_subject_rules_review_status_t;
...
typedef struct io_k8s_api_authorization_v1beta1_subject_rules_review_status_t {
...
#endif /* _io_k8s_api_authorization_v1beta1_subject_rules_review_status_H_ */
