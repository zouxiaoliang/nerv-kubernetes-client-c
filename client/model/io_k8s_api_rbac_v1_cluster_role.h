/*
 * io_k8s_api_rbac_v1_cluster_role.h
 *
 * ClusterRole is a cluster level, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding or ClusterRoleBinding.
 */

#ifndef _io_k8s_api_rbac_v1_cluster_role_H_
#define _io_k8s_api_rbac_v1_cluster_role_H_
...
typedef struct io_k8s_api_rbac_v1_cluster_role_t io_k8s_api_rbac_v1_cluster_role_t;
...
typedef struct io_k8s_api_rbac_v1_cluster_role_t {
    struct io_k8s_api_rbac_v1_aggregation_rule_t *aggregation_rule; //model
...
#endif /* _io_k8s_api_rbac_v1_cluster_role_H_ */
