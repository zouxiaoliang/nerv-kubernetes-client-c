/*
 * io_k8s_api_autoscaling_v2beta1_container_resource_metric_status.h
 *
 * ContainerResourceMetricStatus indicates the current value of a resource metric known to Kubernetes, as specified in requests and limits, describing a single container in each pod in the current scale target (e.g. CPU or memory).  Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \&quot;pods\&quot; source.
 */

#ifndef _io_k8s_api_autoscaling_v2beta1_container_resource_metric_status_H_
#define _io_k8s_api_autoscaling_v2beta1_container_resource_metric_status_H_
...
typedef struct io_k8s_api_autoscaling_v2beta1_container_resource_metric_status_t io_k8s_api_autoscaling_v2beta1_container_resource_metric_status_t;
...
#endif /* _io_k8s_api_autoscaling_v2beta1_container_resource_metric_status_H_ */
