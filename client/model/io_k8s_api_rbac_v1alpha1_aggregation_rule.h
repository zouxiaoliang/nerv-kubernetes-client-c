/*
 * io_k8s_api_rbac_v1alpha1_aggregation_rule.h
 *
 * AggregationRule describes how to locate ClusterRoles to aggregate into the ClusterRole
 */

#ifndef _io_k8s_api_rbac_v1alpha1_aggregation_rule_H_
#define _io_k8s_api_rbac_v1alpha1_aggregation_rule_H_
...
typedef struct io_k8s_api_rbac_v1alpha1_aggregation_rule_t io_k8s_api_rbac_v1alpha1_aggregation_rule_t;

#include "io_k8s_apimachinery_pkg_apis_meta_v1_label_selector.h"



typedef struct io_k8s_api_rbac_v1alpha1_aggregation_rule_t {
...
#endif /* _io_k8s_api_rbac_v1alpha1_aggregation_rule_H_ */
