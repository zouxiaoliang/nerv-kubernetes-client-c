/*
 * io_k8s_api_networking_v1beta1_ingress_class.h
 *
 * IngressClass represents the class of the Ingress, referenced by the Ingress Spec. The &#x60;ingressclass.kubernetes.io/is-default-class&#x60; annotation can be used to indicate that an IngressClass should be considered default. When a single IngressClass resource has this annotation set to true, new Ingress resources without a class specified will be assigned this default class.
 */

#ifndef _io_k8s_api_networking_v1beta1_ingress_class_H_
#define _io_k8s_api_networking_v1beta1_ingress_class_H_
...
typedef struct io_k8s_api_networking_v1beta1_ingress_class_t io_k8s_api_networking_v1beta1_ingress_class_t;
...
typedef struct io_k8s_api_networking_v1beta1_ingress_class_t {
    char *api_version; // string
    char *kind; // string
    struct io_k8s_apimachinery_pkg_apis_meta_v1_object_meta_t *metadata; //model
    struct io_k8s_api_networking_v1beta1_ingress_class_spec_t *spec; //model
...
#endif /* _io_k8s_api_networking_v1beta1_ingress_class_H_ */
