...
NodeV1alpha1API_createNodeV1alpha1RuntimeClass(apiClient_t *apiClient, io_k8s_api_node_v1alpha1_runtime_class_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_node_v1alpha1_runtime_class_convertToJSON(body);
    ...
    io_k8s_api_node_v1alpha1_runtime_class_t *elementToReturn = io_k8s_api_node_v1alpha1_runtime_class_parseFromJSON(NodeV1alpha1APIlocalVarJSON);
...
NodeV1alpha1API_deleteNodeV1alpha1CollectionRuntimeClass(apiClient_t *apiClient, char * pretty , char * _continue , char * dryRun , char * fieldSelector , int gracePeriodSeconds , char * labelSelector , int limit , int orphanDependents , char * propagationPolicy , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *NodeV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_status_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_status_parseFromJSON(NodeV1alpha1APIlocalVarJSON);
    cJSON_Delete(NodeV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_apimachinery_pkg_apis_meta_v1_status_t*
NodeV1alpha1API_deleteNodeV1alpha1RuntimeClass(apiClient_t *apiClient, char * name , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
NodeV1alpha1API_getNodeV1alpha1APIResources(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *NodeV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_parseFromJSON(NodeV1alpha1APIlocalVarJSON);
    cJSON_Delete(NodeV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
NodeV1alpha1API_listNodeV1alpha1RuntimeClass(apiClient_t *apiClient, char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *NodeV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_api_node_v1alpha1_runtime_class_list_t *elementToReturn = io_k8s_api_node_v1alpha1_runtime_class_list_parseFromJSON(NodeV1alpha1APIlocalVarJSON);
    cJSON_Delete(NodeV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_api_node_v1alpha1_runtime_class_t*
NodeV1alpha1API_readNodeV1alpha1RuntimeClass(apiClient_t *apiClient, char * name , char * pretty )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_api_node_v1alpha1_runtime_class_t*
NodeV1alpha1API_replaceNodeV1alpha1RuntimeClass(apiClient_t *apiClient, char * name , io_k8s_api_node_v1alpha1_runtime_class_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
NodeV1alpha1API_watchNodeV1alpha1RuntimeClass(apiClient_t *apiClient, char * name , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/node.k8s.io/v1alpha1/watch/runtimeclasses/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/node.k8s.io/v1alpha1/watch/runtimeclasses/{name}");
    ...
    //nonprimitive not container
    cJSON *NodeV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_parseFromJSON(NodeV1alpha1APIlocalVarJSON);
    cJSON_Delete(NodeV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t*
NodeV1alpha1API_watchNodeV1alpha1RuntimeClassList(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/node.k8s.io/v1alpha1/watch/runtimeclasses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/node.k8s.io/v1alpha1/watch/runtimeclasses");
