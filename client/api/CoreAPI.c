...
CoreAPI_getCoreAPIVersions(apiClient_t *apiClient)
{
    ...
    io_k8s_apimachinery_pkg_apis_meta_v1_api_versions_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_versions_parseFromJSON(CoreAPIlocalVarJSON);
