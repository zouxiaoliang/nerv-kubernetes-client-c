...
ApisAPI_getAPIVersions(apiClient_t *apiClient)
{
    ...
    io_k8s_apimachinery_pkg_apis_meta_v1_api_group_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_group_list_parseFromJSON(ApisAPIlocalVarJSON);
