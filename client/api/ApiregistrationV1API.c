...
ApiregistrationV1API_createApiregistrationV1APIService(apiClient_t *apiClient, io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_convertToJSON(body);
    ...
    io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_t *elementToReturn = io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_parseFromJSON(ApiregistrationV1APIlocalVarJSON);
...
ApiregistrationV1API_deleteApiregistrationV1APIService(apiClient_t *apiClient, char * name , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *ApiregistrationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_status_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_status_parseFromJSON(ApiregistrationV1APIlocalVarJSON);
    cJSON_Delete(ApiregistrationV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ApiregistrationV1API_getApiregistrationV1APIResources(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *ApiregistrationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_parseFromJSON(ApiregistrationV1APIlocalVarJSON);
    cJSON_Delete(ApiregistrationV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ApiregistrationV1API_listApiregistrationV1APIService(apiClient_t *apiClient, char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *ApiregistrationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_list_t *elementToReturn = io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_list_parseFromJSON(ApiregistrationV1APIlocalVarJSON);
    cJSON_Delete(ApiregistrationV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_t*
ApiregistrationV1API_readApiregistrationV1APIService(apiClient_t *apiClient, char * name , char * pretty )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_t*
ApiregistrationV1API_replaceApiregistrationV1APIService(apiClient_t *apiClient, char * name , io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_t*
ApiregistrationV1API_replaceApiregistrationV1APIServiceStatus(apiClient_t *apiClient, char * name , io_k8s_kube_aggregator_pkg_apis_apiregistration_v1_api_service_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
ApiregistrationV1API_watchApiregistrationV1APIService(apiClient_t *apiClient, char * name , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/apiregistration.k8s.io/v1/watch/apiservices/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/apiregistration.k8s.io/v1/watch/apiservices/{name}");
    ...
    //nonprimitive not container
    cJSON *ApiregistrationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_parseFromJSON(ApiregistrationV1APIlocalVarJSON);
    cJSON_Delete(ApiregistrationV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t*
ApiregistrationV1API_watchApiregistrationV1APIServiceList(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/apiregistration.k8s.io/v1/watch/apiservices")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/apiregistration.k8s.io/v1/watch/apiservices");
