...
DiscoveryV1beta1API_createDiscoveryV1beta1NamespacedEndpointSlice(apiClient_t *apiClient, char * _namespace , io_k8s_api_discovery_v1beta1_endpoint_slice_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices");
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_discovery_v1beta1_endpoint_slice_convertToJSON(body);
    ...
    io_k8s_api_discovery_v1beta1_endpoint_slice_t *elementToReturn = io_k8s_api_discovery_v1beta1_endpoint_slice_parseFromJSON(DiscoveryV1beta1APIlocalVarJSON);
    cJSON_Delete(DiscoveryV1beta1APIlocalVarJSON);
...
DiscoveryV1beta1API_deleteDiscoveryV1beta1CollectionNamespacedEndpointSlice(apiClient_t *apiClient, char * _namespace , char * pretty , char * _continue , char * dryRun , char * fieldSelector , int gracePeriodSeconds , char * labelSelector , int limit , int orphanDependents , char * propagationPolicy , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    ...
    //nonprimitive not container
    cJSON *DiscoveryV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_status_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_status_parseFromJSON(DiscoveryV1beta1APIlocalVarJSON);
    cJSON_Delete(DiscoveryV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
DiscoveryV1beta1API_deleteDiscoveryV1beta1NamespacedEndpointSlice(apiClient_t *apiClient, char * name , char * _namespace , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices/{name}");
...
DiscoveryV1beta1API_getDiscoveryV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1beta1/");
    ...
    //nonprimitive not container
    cJSON *DiscoveryV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_parseFromJSON(DiscoveryV1beta1APIlocalVarJSON);
    cJSON_Delete(DiscoveryV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
DiscoveryV1beta1API_listDiscoveryV1beta1EndpointSliceForAllNamespaces(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1beta1/endpointslices")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1beta1/endpointslices");
    ...
    //nonprimitive not container
    cJSON *DiscoveryV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_api_discovery_v1beta1_endpoint_slice_list_t *elementToReturn = io_k8s_api_discovery_v1beta1_endpoint_slice_list_parseFromJSON(DiscoveryV1beta1APIlocalVarJSON);
    cJSON_Delete(DiscoveryV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
DiscoveryV1beta1API_watchDiscoveryV1beta1EndpointSliceListForAllNamespaces(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1beta1/watch/endpointslices")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1beta1/watch/endpointslices");
    ...
    //nonprimitive not container
    cJSON *DiscoveryV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_parseFromJSON(DiscoveryV1beta1APIlocalVarJSON);
    cJSON_Delete(DiscoveryV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
DiscoveryV1beta1API_watchDiscoveryV1beta1NamespacedEndpointSlice(apiClient_t *apiClient, char * name , char * _namespace , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1beta1/watch/namespaces/{namespace}/endpointslices/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1beta1/watch/namespaces/{namespace}/endpointslices/{name}");
...
DiscoveryV1beta1API_watchDiscoveryV1beta1NamespacedEndpointSliceList(apiClient_t *apiClient, char * _namespace , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1beta1/watch/namespaces/{namespace}/endpointslices")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1beta1/watch/namespaces/{namespace}/endpointslices");
