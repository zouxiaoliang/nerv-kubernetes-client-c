...
SchedulingV1API_createSchedulingV1PriorityClass(apiClient_t *apiClient, io_k8s_api_scheduling_v1_priority_class_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_scheduling_v1_priority_class_convertToJSON(body);
    ...
    io_k8s_api_scheduling_v1_priority_class_t *elementToReturn = io_k8s_api_scheduling_v1_priority_class_parseFromJSON(SchedulingV1APIlocalVarJSON);
...
SchedulingV1API_deleteSchedulingV1CollectionPriorityClass(apiClient_t *apiClient, char * pretty , char * _continue , char * dryRun , char * fieldSelector , int gracePeriodSeconds , char * labelSelector , int limit , int orphanDependents , char * propagationPolicy , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    ...
    //nonprimitive not container
    cJSON *SchedulingV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_status_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_status_parseFromJSON(SchedulingV1APIlocalVarJSON);
    cJSON_Delete(SchedulingV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_apimachinery_pkg_apis_meta_v1_status_t*
SchedulingV1API_deleteSchedulingV1PriorityClass(apiClient_t *apiClient, char * name , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
SchedulingV1API_getSchedulingV1APIResources(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *SchedulingV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_parseFromJSON(SchedulingV1APIlocalVarJSON);
    cJSON_Delete(SchedulingV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SchedulingV1API_listSchedulingV1PriorityClass(apiClient_t *apiClient, char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *SchedulingV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_api_scheduling_v1_priority_class_list_t *elementToReturn = io_k8s_api_scheduling_v1_priority_class_list_parseFromJSON(SchedulingV1APIlocalVarJSON);
    cJSON_Delete(SchedulingV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_api_scheduling_v1_priority_class_t*
SchedulingV1API_readSchedulingV1PriorityClass(apiClient_t *apiClient, char * name , char * pretty )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_api_scheduling_v1_priority_class_t*
SchedulingV1API_replaceSchedulingV1PriorityClass(apiClient_t *apiClient, char * name , io_k8s_api_scheduling_v1_priority_class_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
SchedulingV1API_watchSchedulingV1PriorityClass(apiClient_t *apiClient, char * name , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/scheduling.k8s.io/v1/watch/priorityclasses/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/scheduling.k8s.io/v1/watch/priorityclasses/{name}");
    ...
    //nonprimitive not container
    cJSON *SchedulingV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_parseFromJSON(SchedulingV1APIlocalVarJSON);
    cJSON_Delete(SchedulingV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t*
SchedulingV1API_watchSchedulingV1PriorityClassList(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/scheduling.k8s.io/v1/watch/priorityclasses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/scheduling.k8s.io/v1/watch/priorityclasses");
