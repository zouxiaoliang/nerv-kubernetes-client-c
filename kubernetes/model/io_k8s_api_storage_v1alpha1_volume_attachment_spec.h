/*
 * io_k8s_api_storage_v1alpha1_volume_attachment_spec.h
 *
 * VolumeAttachmentSpec is the specification of a VolumeAttachment request.
 */

#ifndef _io_k8s_api_storage_v1alpha1_volume_attachment_spec_H_
#define _io_k8s_api_storage_v1alpha1_volume_attachment_spec_H_
...
typedef struct io_k8s_api_storage_v1alpha1_volume_attachment_spec_t io_k8s_api_storage_v1alpha1_volume_attachment_spec_t;

#include "io_k8s_api_storage_v1alpha1_volume_attachment_source.h"



typedef struct io_k8s_api_storage_v1alpha1_volume_attachment_spec_t {
    char *attacher; // string
    char *node_name; // string
    struct io_k8s_api_storage_v1alpha1_volume_attachment_source_t *source; //model
...
#endif /* _io_k8s_api_storage_v1alpha1_volume_attachment_spec_H_ */
