...
#include <string.h>
#include <stdio.h>
#include "io_k8s_api_rbac_v1_aggregation_rule.h"
...
io_k8s_api_rbac_v1_aggregation_rule_t *io_k8s_api_rbac_v1_aggregation_rule_create(
    ...
    io_k8s_api_rbac_v1_aggregation_rule_t *io_k8s_api_rbac_v1_aggregation_rule_local_var = malloc(sizeof(io_k8s_api_rbac_v1_aggregation_rule_t));
    if (!io_k8s_api_rbac_v1_aggregation_rule_local_var) {
        return NULL;
    }
    io_k8s_api_rbac_v1_aggregation_rule_local_var->cluster_role_selectors = cluster_role_selectors;

    return io_k8s_api_rbac_v1_aggregation_rule_local_var;
}


void io_k8s_api_rbac_v1_aggregation_rule_free(io_k8s_api_rbac_v1_aggregation_rule_t *io_k8s_api_rbac_v1_aggregation_rule) {
    if(NULL == io_k8s_api_rbac_v1_aggregation_rule){
        return ;
    }
    listEntry_t *listEntry;
    if (io_k8s_api_rbac_v1_aggregation_rule->cluster_role_selectors) {
        list_ForEach(listEntry, io_k8s_api_rbac_v1_aggregation_rule->cluster_role_selectors) {
            io_k8s_apimachinery_pkg_apis_meta_v1_label_selector_free(listEntry->data);
        }
        list_free(io_k8s_api_rbac_v1_aggregation_rule->cluster_role_selectors);
        io_k8s_api_rbac_v1_aggregation_rule->cluster_role_selectors = NULL;
    }
    free(io_k8s_api_rbac_v1_aggregation_rule);
}
...
cJSON *io_k8s_api_rbac_v1_aggregation_rule_convertToJSON(io_k8s_api_rbac_v1_aggregation_rule_t *io_k8s_api_rbac_v1_aggregation_rule) {
    ...
    // io_k8s_api_rbac_v1_aggregation_rule->cluster_role_selectors
    if(io_k8s_api_rbac_v1_aggregation_rule->cluster_role_selectors) { 
    ...
    if (io_k8s_api_rbac_v1_aggregation_rule->cluster_role_selectors) {
    list_ForEach(cluster_role_selectorsListEntry, io_k8s_api_rbac_v1_aggregation_rule->cluster_role_selectors) {
...
io_k8s_api_rbac_v1_aggregation_rule_t *io_k8s_api_rbac_v1_aggregation_rule_parseFromJSON(cJSON *io_k8s_api_rbac_v1_aggregation_ruleJSON){
    ...
    io_k8s_api_rbac_v1_aggregation_rule_t *io_k8s_api_rbac_v1_aggregation_rule_local_var = NULL;

    // io_k8s_api_rbac_v1_aggregation_rule->cluster_role_selectors
    cJSON *cluster_role_selectors = cJSON_GetObjectItemCaseSensitive(io_k8s_api_rbac_v1_aggregation_ruleJSON, "clusterRoleSelectors");
    ...
    io_k8s_api_rbac_v1_aggregation_rule_local_var = io_k8s_api_rbac_v1_aggregation_rule_create (
