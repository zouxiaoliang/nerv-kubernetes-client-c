/*
 * io_k8s_api_core_v1_storage_os_volume_source.h
 *
 * Represents a StorageOS persistent volume resource.
 */

#ifndef _io_k8s_api_core_v1_storage_os_volume_source_H_
#define _io_k8s_api_core_v1_storage_os_volume_source_H_
...
typedef struct io_k8s_api_core_v1_storage_os_volume_source_t io_k8s_api_core_v1_storage_os_volume_source_t;

#include "io_k8s_api_core_v1_local_object_reference.h"



typedef struct io_k8s_api_core_v1_storage_os_volume_source_t {
    char *fs_type; // string
...
#endif /* _io_k8s_api_core_v1_storage_os_volume_source_H_ */
