...
io_k8s_api_node_v1alpha1_scheduling_t *io_k8s_api_node_v1alpha1_scheduling_create(
    ...
    io_k8s_api_node_v1alpha1_scheduling_t *io_k8s_api_node_v1alpha1_scheduling_local_var = malloc(sizeof(io_k8s_api_node_v1alpha1_scheduling_t));
    if (!io_k8s_api_node_v1alpha1_scheduling_local_var) {
        return NULL;
    }
    io_k8s_api_node_v1alpha1_scheduling_local_var->node_selector = node_selector;
    io_k8s_api_node_v1alpha1_scheduling_local_var->tolerations = tolerations;

    return io_k8s_api_node_v1alpha1_scheduling_local_var;
}


void io_k8s_api_node_v1alpha1_scheduling_free(io_k8s_api_node_v1alpha1_scheduling_t *io_k8s_api_node_v1alpha1_scheduling) {
    if(NULL == io_k8s_api_node_v1alpha1_scheduling){
        return ;
    }
    listEntry_t *listEntry;
    if (io_k8s_api_node_v1alpha1_scheduling->node_selector) {
        list_ForEach(listEntry, io_k8s_api_node_v1alpha1_scheduling->node_selector) {
            keyValuePair_t *localKeyValue = (keyValuePair_t*) listEntry->data;
            free (localKeyValue->key);
            free (localKeyValue->value);
            keyValuePair_free(localKeyValue);
        }
        list_free(io_k8s_api_node_v1alpha1_scheduling->node_selector);
        io_k8s_api_node_v1alpha1_scheduling->node_selector = NULL;
    }
    if (io_k8s_api_node_v1alpha1_scheduling->tolerations) {
        list_ForEach(listEntry, io_k8s_api_node_v1alpha1_scheduling->tolerations) {
            io_k8s_api_core_v1_toleration_free(listEntry->data);
        }
        list_free(io_k8s_api_node_v1alpha1_scheduling->tolerations);
        io_k8s_api_node_v1alpha1_scheduling->tolerations = NULL;
    }
    free(io_k8s_api_node_v1alpha1_scheduling);
}
...
cJSON *io_k8s_api_node_v1alpha1_scheduling_convertToJSON(io_k8s_api_node_v1alpha1_scheduling_t *io_k8s_api_node_v1alpha1_scheduling) {
    ...
    // io_k8s_api_node_v1alpha1_scheduling->node_selector
    if(io_k8s_api_node_v1alpha1_scheduling->node_selector) { 
    ...
    if (io_k8s_api_node_v1alpha1_scheduling->node_selector) {
    list_ForEach(node_selectorListEntry, io_k8s_api_node_v1alpha1_scheduling->node_selector) {
    ...
    // io_k8s_api_node_v1alpha1_scheduling->tolerations
    if(io_k8s_api_node_v1alpha1_scheduling->tolerations) { 
    ...
    if (io_k8s_api_node_v1alpha1_scheduling->tolerations) {
    list_ForEach(tolerationsListEntry, io_k8s_api_node_v1alpha1_scheduling->tolerations) {
...
io_k8s_api_node_v1alpha1_scheduling_t *io_k8s_api_node_v1alpha1_scheduling_parseFromJSON(cJSON *io_k8s_api_node_v1alpha1_schedulingJSON){
    ...
    io_k8s_api_node_v1alpha1_scheduling_t *io_k8s_api_node_v1alpha1_scheduling_local_var = NULL;

    // io_k8s_api_node_v1alpha1_scheduling->node_selector
    cJSON *node_selector = cJSON_GetObjectItemCaseSensitive(io_k8s_api_node_v1alpha1_schedulingJSON, "nodeSelector");
    ...
    // io_k8s_api_node_v1alpha1_scheduling->tolerations
    cJSON *tolerations = cJSON_GetObjectItemCaseSensitive(io_k8s_api_node_v1alpha1_schedulingJSON, "tolerations");
    ...
    io_k8s_api_node_v1alpha1_scheduling_local_var = io_k8s_api_node_v1alpha1_scheduling_create (
