/*
 * io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler.h
 *
 * HorizontalPodAutoscaler is the configuration for a horizontal pod autoscaler, which automatically manages the replica count of any resource implementing the scale subresource based on the metrics specified.
 */

#ifndef _io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler_H_
#define _io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler_H_
...
typedef struct io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler_t io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler_t;
...
typedef struct io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler_t {
    char *api_version; // string
    char *kind; // string
    struct io_k8s_apimachinery_pkg_apis_meta_v1_object_meta_t *metadata; //model
    struct io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler_spec_t *spec; //model
    struct io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler_status_t *status; //model
...
#endif /* _io_k8s_api_autoscaling_v2beta1_horizontal_pod_autoscaler_H_ */
