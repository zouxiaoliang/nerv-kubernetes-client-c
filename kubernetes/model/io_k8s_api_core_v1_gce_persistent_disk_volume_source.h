/*
 * io_k8s_api_core_v1_gce_persistent_disk_volume_source.h
 *
 * Represents a Persistent Disk resource in Google Compute Engine.  A GCE PD must exist before mounting to a container. The disk must also be in the same GCE project and zone as the kubelet. A GCE PD can only be mounted as read/write once or read-only many times. GCE PDs support ownership management and SELinux relabeling.
 */

#ifndef _io_k8s_api_core_v1_gce_persistent_disk_volume_source_H_
#define _io_k8s_api_core_v1_gce_persistent_disk_volume_source_H_
...
typedef struct io_k8s_api_core_v1_gce_persistent_disk_volume_source_t io_k8s_api_core_v1_gce_persistent_disk_volume_source_t;




typedef struct io_k8s_api_core_v1_gce_persistent_disk_volume_source_t {
    char *fs_type; // string
...
#endif /* _io_k8s_api_core_v1_gce_persistent_disk_volume_source_H_ */
