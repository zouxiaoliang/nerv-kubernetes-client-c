/*
 * io_k8s_api_storage_v1_volume_attachment_source.h
 *
 * VolumeAttachmentSource represents a volume that should be attached. Right now only PersistenVolumes can be attached via external attacher, in future we may allow also inline volumes in pods. Exactly one member can be set.
 */

#ifndef _io_k8s_api_storage_v1_volume_attachment_source_H_
#define _io_k8s_api_storage_v1_volume_attachment_source_H_
...
typedef struct io_k8s_api_storage_v1_volume_attachment_source_t io_k8s_api_storage_v1_volume_attachment_source_t;

#include "io_k8s_api_core_v1_persistent_volume_spec.h"



typedef struct io_k8s_api_storage_v1_volume_attachment_source_t {
...
#endif /* _io_k8s_api_storage_v1_volume_attachment_source_H_ */
