/*
 * io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_json_schema_props.h
 *
 * JSONSchemaProps is a JSON-Schema following Specification Draft 4 (http://json-schema.org/).
 */

#ifndef _io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_json_schema_props_H_
#define _io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_json_schema_props_H_
...
typedef struct io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_json_schema_props_t io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_json_schema_props_t;
...
typedef struct io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_json_schema_props_t {
    char *ref; // string
    char *schema; // string
    ...
    struct io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_external_documentation_t *external_docs; //model
    char *format; // string
    char *id; // string
    ...
    struct io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_json_schema_props_t *_not; //model
...
#endif /* _io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_json_schema_props_H_ */
