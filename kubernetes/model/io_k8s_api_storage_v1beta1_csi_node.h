/*
 * io_k8s_api_storage_v1beta1_csi_node.h
 *
...
#ifndef _io_k8s_api_storage_v1beta1_csi_node_H_
#define _io_k8s_api_storage_v1beta1_csi_node_H_
...
typedef struct io_k8s_api_storage_v1beta1_csi_node_t io_k8s_api_storage_v1beta1_csi_node_t;
...
typedef struct io_k8s_api_storage_v1beta1_csi_node_t {
    char *api_version; // string
    char *kind; // string
    struct io_k8s_apimachinery_pkg_apis_meta_v1_object_meta_t *metadata; //model
    struct io_k8s_api_storage_v1beta1_csi_node_spec_t *spec; //model
...
#endif /* _io_k8s_api_storage_v1beta1_csi_node_H_ */
