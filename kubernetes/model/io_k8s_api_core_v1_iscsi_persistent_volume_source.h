/*
 * io_k8s_api_core_v1_iscsi_persistent_volume_source.h
 *
 * ISCSIPersistentVolumeSource represents an ISCSI disk. ISCSI volumes can only be mounted as read/write once. ISCSI volumes support ownership management and SELinux relabeling.
 */

#ifndef _io_k8s_api_core_v1_iscsi_persistent_volume_source_H_
#define _io_k8s_api_core_v1_iscsi_persistent_volume_source_H_
...
typedef struct io_k8s_api_core_v1_iscsi_persistent_volume_source_t io_k8s_api_core_v1_iscsi_persistent_volume_source_t;

#include "io_k8s_api_core_v1_secret_reference.h"



typedef struct io_k8s_api_core_v1_iscsi_persistent_volume_source_t {
...
#endif /* _io_k8s_api_core_v1_iscsi_persistent_volume_source_H_ */
