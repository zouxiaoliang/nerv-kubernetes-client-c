...
io_k8s_api_core_v1_pod_affinity_t *io_k8s_api_core_v1_pod_affinity_create(
    ...
    io_k8s_api_core_v1_pod_affinity_t *io_k8s_api_core_v1_pod_affinity_local_var = malloc(sizeof(io_k8s_api_core_v1_pod_affinity_t));
    if (!io_k8s_api_core_v1_pod_affinity_local_var) {
        return NULL;
    }
    io_k8s_api_core_v1_pod_affinity_local_var->preferred_during_scheduling_ignored_during_execution = preferred_during_scheduling_ignored_during_execution;
    io_k8s_api_core_v1_pod_affinity_local_var->required_during_scheduling_ignored_during_execution = required_during_scheduling_ignored_during_execution;

    return io_k8s_api_core_v1_pod_affinity_local_var;
}


void io_k8s_api_core_v1_pod_affinity_free(io_k8s_api_core_v1_pod_affinity_t *io_k8s_api_core_v1_pod_affinity) {
    if(NULL == io_k8s_api_core_v1_pod_affinity){
        return ;
    }
    listEntry_t *listEntry;
    if (io_k8s_api_core_v1_pod_affinity->preferred_during_scheduling_ignored_during_execution) {
        list_ForEach(listEntry, io_k8s_api_core_v1_pod_affinity->preferred_during_scheduling_ignored_during_execution) {
            io_k8s_api_core_v1_weighted_pod_affinity_term_free(listEntry->data);
        }
        list_free(io_k8s_api_core_v1_pod_affinity->preferred_during_scheduling_ignored_during_execution);
        io_k8s_api_core_v1_pod_affinity->preferred_during_scheduling_ignored_during_execution = NULL;
    }
    if (io_k8s_api_core_v1_pod_affinity->required_during_scheduling_ignored_during_execution) {
        list_ForEach(listEntry, io_k8s_api_core_v1_pod_affinity->required_during_scheduling_ignored_during_execution) {
            io_k8s_api_core_v1_pod_affinity_term_free(listEntry->data);
        }
        list_free(io_k8s_api_core_v1_pod_affinity->required_during_scheduling_ignored_during_execution);
        io_k8s_api_core_v1_pod_affinity->required_during_scheduling_ignored_during_execution = NULL;
    }
    free(io_k8s_api_core_v1_pod_affinity);
}
...
cJSON *io_k8s_api_core_v1_pod_affinity_convertToJSON(io_k8s_api_core_v1_pod_affinity_t *io_k8s_api_core_v1_pod_affinity) {
    ...
    // io_k8s_api_core_v1_pod_affinity->preferred_during_scheduling_ignored_during_execution
    if(io_k8s_api_core_v1_pod_affinity->preferred_during_scheduling_ignored_during_execution) { 
    ...
    if (io_k8s_api_core_v1_pod_affinity->preferred_during_scheduling_ignored_during_execution) {
    list_ForEach(preferred_during_scheduling_ignored_during_executionListEntry, io_k8s_api_core_v1_pod_affinity->preferred_during_scheduling_ignored_during_execution) {
    ...
    // io_k8s_api_core_v1_pod_affinity->required_during_scheduling_ignored_during_execution
    if(io_k8s_api_core_v1_pod_affinity->required_during_scheduling_ignored_during_execution) { 
    ...
    if (io_k8s_api_core_v1_pod_affinity->required_during_scheduling_ignored_during_execution) {
    list_ForEach(required_during_scheduling_ignored_during_executionListEntry, io_k8s_api_core_v1_pod_affinity->required_during_scheduling_ignored_during_execution) {
...
io_k8s_api_core_v1_pod_affinity_t *io_k8s_api_core_v1_pod_affinity_parseFromJSON(cJSON *io_k8s_api_core_v1_pod_affinityJSON){
    ...
    io_k8s_api_core_v1_pod_affinity_t *io_k8s_api_core_v1_pod_affinity_local_var = NULL;

    // io_k8s_api_core_v1_pod_affinity->preferred_during_scheduling_ignored_during_execution
    cJSON *preferred_during_scheduling_ignored_during_execution = cJSON_GetObjectItemCaseSensitive(io_k8s_api_core_v1_pod_affinityJSON, "preferredDuringSchedulingIgnoredDuringExecution");
    ...
    // io_k8s_api_core_v1_pod_affinity->required_during_scheduling_ignored_during_execution
    cJSON *required_during_scheduling_ignored_during_execution = cJSON_GetObjectItemCaseSensitive(io_k8s_api_core_v1_pod_affinityJSON, "requiredDuringSchedulingIgnoredDuringExecution");
    ...
    io_k8s_api_core_v1_pod_affinity_local_var = io_k8s_api_core_v1_pod_affinity_create (
