/*
 * io_k8s_api_core_v1_flex_persistent_volume_source.h
 *
 * FlexPersistentVolumeSource represents a generic persistent volume resource that is provisioned/attached using an exec based plugin.
 */

#ifndef _io_k8s_api_core_v1_flex_persistent_volume_source_H_
#define _io_k8s_api_core_v1_flex_persistent_volume_source_H_
...
typedef struct io_k8s_api_core_v1_flex_persistent_volume_source_t io_k8s_api_core_v1_flex_persistent_volume_source_t;

#include "io_k8s_api_core_v1_secret_reference.h"



typedef struct io_k8s_api_core_v1_flex_persistent_volume_source_t {
    char *driver; // string
    char *fs_type; // string
    list_t* options; //map
...
#endif /* _io_k8s_api_core_v1_flex_persistent_volume_source_H_ */
