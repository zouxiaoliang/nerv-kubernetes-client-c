/*
 * io_k8s_api_authentication_v1beta1_user_info.h
 *
 * UserInfo holds the information about the user needed to implement the user.Info interface.
 */

#ifndef _io_k8s_api_authentication_v1beta1_user_info_H_
#define _io_k8s_api_authentication_v1beta1_user_info_H_
...
typedef struct io_k8s_api_authentication_v1beta1_user_info_t io_k8s_api_authentication_v1beta1_user_info_t;




typedef struct io_k8s_api_authentication_v1beta1_user_info_t {
    list_t* extra; //map
...
#endif /* _io_k8s_api_authentication_v1beta1_user_info_H_ */
