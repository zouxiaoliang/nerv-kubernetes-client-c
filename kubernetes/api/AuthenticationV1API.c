...
AuthenticationV1API_createAuthenticationV1TokenReview(apiClient_t *apiClient, io_k8s_api_authentication_v1_token_review_t * body , char * dryRun , char * fieldManager , char * pretty )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_authentication_v1_token_review_convertToJSON(body);
    ...
    io_k8s_api_authentication_v1_token_review_t *elementToReturn = io_k8s_api_authentication_v1_token_review_parseFromJSON(AuthenticationV1APIlocalVarJSON);
...
AuthenticationV1API_getAuthenticationV1APIResources(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *AuthenticationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_parseFromJSON(AuthenticationV1APIlocalVarJSON);
    cJSON_Delete(AuthenticationV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
