...
CertificatesV1beta1API_createCertificatesV1beta1CertificateSigningRequest(apiClient_t *apiClient, io_k8s_api_certificates_v1beta1_certificate_signing_request_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_certificates_v1beta1_certificate_signing_request_convertToJSON(body);
    ...
    io_k8s_api_certificates_v1beta1_certificate_signing_request_t *elementToReturn = io_k8s_api_certificates_v1beta1_certificate_signing_request_parseFromJSON(CertificatesV1beta1APIlocalVarJSON);
...
CertificatesV1beta1API_deleteCertificatesV1beta1CertificateSigningRequest(apiClient_t *apiClient, char * name , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *CertificatesV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_status_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_status_parseFromJSON(CertificatesV1beta1APIlocalVarJSON);
    cJSON_Delete(CertificatesV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CertificatesV1beta1API_getCertificatesV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *CertificatesV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_parseFromJSON(CertificatesV1beta1APIlocalVarJSON);
    cJSON_Delete(CertificatesV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CertificatesV1beta1API_listCertificatesV1beta1CertificateSigningRequest(apiClient_t *apiClient, char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *CertificatesV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_api_certificates_v1beta1_certificate_signing_request_list_t *elementToReturn = io_k8s_api_certificates_v1beta1_certificate_signing_request_list_parseFromJSON(CertificatesV1beta1APIlocalVarJSON);
    cJSON_Delete(CertificatesV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_api_certificates_v1beta1_certificate_signing_request_t*
CertificatesV1beta1API_patchCertificatesV1beta1CertificateSigningRequestApproval(apiClient_t *apiClient, char * name , object_t * body , char * pretty , char * dryRun , char * fieldManager , int force )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_api_certificates_v1beta1_certificate_signing_request_t*
CertificatesV1beta1API_readCertificatesV1beta1CertificateSigningRequest(apiClient_t *apiClient, char * name , char * pretty )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_api_certificates_v1beta1_certificate_signing_request_t*
CertificatesV1beta1API_readCertificatesV1beta1CertificateSigningRequestApproval(apiClient_t *apiClient, char * name , char * pretty )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_api_certificates_v1beta1_certificate_signing_request_t*
CertificatesV1beta1API_replaceCertificatesV1beta1CertificateSigningRequest(apiClient_t *apiClient, char * name , io_k8s_api_certificates_v1beta1_certificate_signing_request_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_api_certificates_v1beta1_certificate_signing_request_t*
CertificatesV1beta1API_replaceCertificatesV1beta1CertificateSigningRequestApproval(apiClient_t *apiClient, char * name , io_k8s_api_certificates_v1beta1_certificate_signing_request_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_api_certificates_v1beta1_certificate_signing_request_t*
CertificatesV1beta1API_replaceCertificatesV1beta1CertificateSigningRequestStatus(apiClient_t *apiClient, char * name , io_k8s_api_certificates_v1beta1_certificate_signing_request_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
CertificatesV1beta1API_watchCertificatesV1beta1CertificateSigningRequest(apiClient_t *apiClient, char * name , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1beta1/watch/certificatesigningrequests/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1beta1/watch/certificatesigningrequests/{name}");
    ...
    //nonprimitive not container
    cJSON *CertificatesV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_parseFromJSON(CertificatesV1beta1APIlocalVarJSON);
    cJSON_Delete(CertificatesV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t*
CertificatesV1beta1API_watchCertificatesV1beta1CertificateSigningRequestList(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1beta1/watch/certificatesigningrequests")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1beta1/watch/certificatesigningrequests");
