...
AuthorizationV1beta1API_createAuthorizationV1beta1NamespacedLocalSubjectAccessReview(apiClient_t *apiClient, char * _namespace , io_k8s_api_authorization_v1beta1_local_subject_access_review_t * body , char * dryRun , char * fieldManager , char * pretty )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_authorization_v1beta1_local_subject_access_review_convertToJSON(body);
    ...
    io_k8s_api_authorization_v1beta1_local_subject_access_review_t *elementToReturn = io_k8s_api_authorization_v1beta1_local_subject_access_review_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
...
AuthorizationV1beta1API_createAuthorizationV1beta1SelfSubjectAccessReview(apiClient_t *apiClient, io_k8s_api_authorization_v1beta1_self_subject_access_review_t * body , char * dryRun , char * fieldManager , char * pretty )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_authorization_v1beta1_self_subject_access_review_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *AuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_api_authorization_v1beta1_self_subject_access_review_t *elementToReturn = io_k8s_api_authorization_v1beta1_self_subject_access_review_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AuthorizationV1beta1API_createAuthorizationV1beta1SelfSubjectRulesReview(apiClient_t *apiClient, io_k8s_api_authorization_v1beta1_self_subject_rules_review_t * body , char * dryRun , char * fieldManager , char * pretty )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_authorization_v1beta1_self_subject_rules_review_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *AuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_api_authorization_v1beta1_self_subject_rules_review_t *elementToReturn = io_k8s_api_authorization_v1beta1_self_subject_rules_review_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AuthorizationV1beta1API_createAuthorizationV1beta1SubjectAccessReview(apiClient_t *apiClient, io_k8s_api_authorization_v1beta1_subject_access_review_t * body , char * dryRun , char * fieldManager , char * pretty )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_authorization_v1beta1_subject_access_review_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    cJSON *AuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_api_authorization_v1beta1_subject_access_review_t *elementToReturn = io_k8s_api_authorization_v1beta1_subject_access_review_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AuthorizationV1beta1API_getAuthorizationV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *AuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
