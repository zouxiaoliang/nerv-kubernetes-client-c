...
AuthenticationV1beta1API_createAuthenticationV1beta1TokenReview(apiClient_t *apiClient, io_k8s_api_authentication_v1beta1_token_review_t * body , char * dryRun , char * fieldManager , char * pretty )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_api_authentication_v1beta1_token_review_convertToJSON(body);
    ...
    io_k8s_api_authentication_v1beta1_token_review_t *elementToReturn = io_k8s_api_authentication_v1beta1_token_review_parseFromJSON(AuthenticationV1beta1APIlocalVarJSON);
...
AuthenticationV1beta1API_getAuthenticationV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *AuthenticationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_parseFromJSON(AuthenticationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthenticationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
