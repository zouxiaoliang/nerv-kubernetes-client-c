...
ApiextensionsV1API_createApiextensionsV1CustomResourceDefinition(apiClient_t *apiClient, io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    ...
    {
        //string
        localVarSingleItemJSON_body = io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_convertToJSON(body);
    ...
    io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_t *elementToReturn = io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_parseFromJSON(ApiextensionsV1APIlocalVarJSON);
...
ApiextensionsV1API_deleteApiextensionsV1CollectionCustomResourceDefinition(apiClient_t *apiClient, char * pretty , char * _continue , char * dryRun , char * fieldSelector , int gracePeriodSeconds , char * labelSelector , int limit , int orphanDependents , char * propagationPolicy , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    ...
    //nonprimitive not container
    cJSON *ApiextensionsV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_status_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_status_parseFromJSON(ApiextensionsV1APIlocalVarJSON);
    cJSON_Delete(ApiextensionsV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_apimachinery_pkg_apis_meta_v1_status_t*
ApiextensionsV1API_deleteApiextensionsV1CustomResourceDefinition(apiClient_t *apiClient, char * name , char * pretty , char * dryRun , int gracePeriodSeconds , int orphanDependents , char * propagationPolicy , io_k8s_apimachinery_pkg_apis_meta_v1_delete_options_t * body )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
ApiextensionsV1API_getApiextensionsV1APIResources(apiClient_t *apiClient)
{
    ...
    //nonprimitive not container
    cJSON *ApiextensionsV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_api_resource_list_parseFromJSON(ApiextensionsV1APIlocalVarJSON);
    cJSON_Delete(ApiextensionsV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ApiextensionsV1API_listApiextensionsV1CustomResourceDefinition(apiClient_t *apiClient, char * pretty , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *ApiextensionsV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_list_t *elementToReturn = io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_list_parseFromJSON(ApiextensionsV1APIlocalVarJSON);
    cJSON_Delete(ApiextensionsV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_t*
ApiextensionsV1API_readApiextensionsV1CustomResourceDefinition(apiClient_t *apiClient, char * name , char * pretty )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_t*
ApiextensionsV1API_replaceApiextensionsV1CustomResourceDefinition(apiClient_t *apiClient, char * name , io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_t*
ApiextensionsV1API_replaceApiextensionsV1CustomResourceDefinitionStatus(apiClient_t *apiClient, char * name , io_k8s_apiextensions_apiserver_pkg_apis_apiextensions_v1_custom_resource_definition_t * body , char * pretty , char * dryRun , char * fieldManager )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
ApiextensionsV1API_watchApiextensionsV1CustomResourceDefinition(apiClient_t *apiClient, char * name , int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions/{name}");
    ...
    //nonprimitive not container
    cJSON *ApiextensionsV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t *elementToReturn = io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_parseFromJSON(ApiextensionsV1APIlocalVarJSON);
    cJSON_Delete(ApiextensionsV1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
io_k8s_apimachinery_pkg_apis_meta_v1_watch_event_t*
ApiextensionsV1API_watchApiextensionsV1CustomResourceDefinitionList(apiClient_t *apiClient, int allowWatchBookmarks , char * _continue , char * fieldSelector , char * labelSelector , int limit , char * pretty , char * resourceVersion , char * resourceVersionMatch , int timeoutSeconds , int watch )
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions");
